...
<!-- Header -->
				...
				<div class="row">
					<div class="col">
						<div class="search_panel_content d-flex flex-row align-items-center justify-content-end">
							<form action="htmlpage/query"  method="post" onsubmit="return myCheckedbox()">
								<div>
	...
	<form action="htmlpage/submitUpdate" method="post" onsubmit="return toVaild()" autocomplete="off">
	<%
	...
	%>
		<div id="dg" style="z-index: 9999; position: fixed ! important; right: 0px; bottom: 0px;">
			<input type="submit" value="提交修改" class="button button5" id="hid">
