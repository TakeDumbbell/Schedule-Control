...
<!-- Header -->
						...
						<div class="header_content d-flex flex-row align-items-center justify-content-start">
							...
							<nav class="main_nav">
								<ul>
									...
									<li style="float:right"><a><input type="checkbox" onclick="SelectAll() "/>全选</a></li>
								</ul>
							</nav>
			...
			<div class="row details_row">
				...
				<div class="col-lg-6">
					<div class="details_content">
						<input type="checkbox" name="category" value="<%=commodity.getId()%>" />
	...
	%>
		<div id="dg" style="z-index: 9999; position: fixed ! important; right: 0px; bottom: 0px;">
			<input type="submit" value="新建网页" class="button button5">
		</div>
	</form>
	</div>
	<!-- Footer -->
